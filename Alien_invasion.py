...
class AlienInvasion:
	...
	def __init__(self):
		...
		# You may run the game in fullscreen mode:
	...
	def _check_bullet_alien_collisions(self):
		...
		# Check for any bullets that have hit an alien. If so, get rid of the
	...
	def _create_alien(self, alien_number, column_number):
		...
		alien.rect.x = 13 * alien.rect.width + 1.5 * alien.rect.width * \
						  column_number
	...
	def _check_aliens_left(self):
		"""Check if an alien has reached the left side of the screen"""
